...
class SentenceFactory {
    ...
    static def String[] getSentencePattern() {
        ...
        final allPatterns = [pattern1, pattern2, pattern3, pattern4, pattern5]
